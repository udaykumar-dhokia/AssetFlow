...
let ResetPasswordDto = (() => {
    ...
    return class ResetPasswordDto {
        static {
            ...
            _otp_decorators = [ApiProperty({ example: '482910' }), IsString(), Length(6, 6)];
            _newPassword_decorators = [ApiProperty({ example: 'NewStrongPass@456', minLength: 8 }), IsString(), MinLength(8)];
